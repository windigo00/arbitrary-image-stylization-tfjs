...
new Vue({
    ...
    computed: {
        ...
        stateMessage() {
            return this.stylingIsReady ? 'Start Styling' : 'Waiting for something';
        }
    },
    ...
    methods: {
        ...
        changeImage(type, values, styleNr) {
            ...
            this.stylingIsReady = this._checkReadyness();
        },
...
//            this.messages.push(`Loading ${type} model`);
//            var that = this;
//            Promise.all([
//                this.dnn.loadModel(type, this.model[type]),
//            ]).then(([result]) => {
...
//        this.dnn = new Dnn;
    ...
    mounted() {
//        this.messages.push('Loading transform model');
//        this.messages.push('Loading style model');
//        var that = this;
